...
fractionalList = [float('0.' + i.split('.')[1]) for i in numsList  if not i.isdigit()] # 0 не учавствует в отборе, если судить по примеру, поэтому дробную часть целых чисел проигнорируем
